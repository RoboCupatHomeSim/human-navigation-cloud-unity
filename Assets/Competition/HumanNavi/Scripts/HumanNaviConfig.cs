...
namespace SIGVerse.Competition.HumanNavigation
{
	...
	public class HumanNaviConfigInfo
	{
		...
		public  int    punMode;
		public  string punAppIdPun;
		public  bool   punUseNameServer;
		public  string punServer;
		public  int    punPort;

		public bool IsPractice()
		{
			return (ExecutionMode)this.executionMode == ExecutionMode.Practice && (PunMode)this.punMode == SIGVerse.Competition.HumanNavigation.PunMode.NotUsed;
		}

		public PunMode PunMode()
		{
			return (PunMode)this.punMode;
		}
	}
	...
	public class HumanNaviConfig : Singleton<HumanNaviConfig>
	{
		...
		void Awake()
		{
			...
			else
			{
				...
				this.configInfo.punMode               = (int)PunMode.NotUsed;
				this.configInfo.punAppIdPun           = "";
				this.configInfo.punUseNameServer      = false;
				this.configInfo.punServer             = "192.168.0.101";
				this.configInfo.punPort               = 5055;
